...
- [ ] Implement JWT authentication dependency (AC: 1)
  - [ ] Create `app/utils/dependencies.py` with `get_current_user` dependency
  - [ ] Implement JWT token extraction from cookie
  - [ ] Implement JWT token validation and decoding
  - [ ] Return user ID and username from token
  - [ ] Raise HTTPException 401 if token invalid or missing
  - [ ] Write tests for authentication dependency
  
- [ ] Create logout endpoint (AC: 1, 2)
  - [ ] Add POST /api/auth/logout to auth_router
  - [ ] Require authentication using Depends(get_current_user)
  - [ ] Create response with cleared cookie (max_age=0)
  - [ ] Return success message
  - [ ] Handle case where user is already logged out gracefully
  
- [ ] Implement cookie clearing logic (AC: 2)
  - [ ] Set cookie with same name as login cookie
  - [ ] Set max_age=0 to expire cookie immediately
  - [ ] Set value to empty string
  - [ ] Maintain httpOnly and secure flags
  - [ ] Test cookie is removed from browser
  
- [ ] Create protected endpoint for testing (AC: 3)
  - [ ] Add GET /api/auth/me endpoint (returns current user info)
  - [ ] Require authentication using get_current_user dependency
  - [ ] Use for testing authentication flow
  - [ ] Return user ID and username
  
- [ ] Write comprehensive tests (AC: 4)
  - [ ] Test logout with valid authentication
  - [ ] Test logout clears cookie
  - [ ] Test subsequent requests fail after logout
  - [ ] Test logout without authentication (edge case)
  - [ ] Test /api/auth/me endpoint requires authentication
