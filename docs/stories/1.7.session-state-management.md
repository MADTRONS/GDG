...
- [ ] Create authentication context (AC: 1)
  - [ ] Create `components/auth/AuthProvider.tsx`
  - [ ] Define AuthContext with user state and auth methods
  - [ ] Implement login function (updates context state)
  - [ ] Implement logout function (clears context state)
  - [ ] Export AuthProvider component
  - [ ] Export useAuth custom hook
  
- [ ] Implement authentication state initialization (AC: 2)
  - [ ] Create function to check auth status on app load
  - [ ] Call GET /api/auth/me endpoint to verify token
  - [ ] Set user data in context if authenticated
  - [ ] Set loading state during initialization
  - [ ] Handle errors gracefully (treat as unauthenticated)
  
- [ ] Integrate AuthProvider in app layout (AC: 1)
  - [ ] Wrap app in `app/layout.tsx` with AuthProvider
  - [ ] Ensure provider wraps all routes
  - [ ] Initialize auth state on mount
  - [ ] Show loading spinner during initialization
  
- [ ] Create protected route wrapper (AC: 3)
...
- [ ] Implement useAuth hook (AC: 4)
  - [ ] Create custom hook that consumes AuthContext
  - [ ] Provide access to user data
  - [ ] Provide access to isAuthenticated boolean
  - [ ] Provide access to login/logout functions
  - [ ] Provide loading state
  - [ ] Throw error if used outside AuthProvider
  
- [ ] Implement logout functionality (AC: 5)
  - [ ] Call POST /api/auth/logout API endpoint
  - [ ] Clear user data from context
  - [ ] Redirect to login page
  - [ ] Handle errors gracefully
  - [ ] Clear any cached data
  
- [ ] Configure API client for cookie handling (AC: 6)
  - [ ] Set credentials: 'include' on all fetch requests
