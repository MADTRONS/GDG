...
- [ ] Add analytics/telemetry (optional)
  - [ ] Log which categories students are interested in
  - [ ] Track button click events
  - [ ] Prepare for future A/B testing
