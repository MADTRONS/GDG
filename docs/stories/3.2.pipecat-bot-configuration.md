...
- [ ] Install PipeCat dependencies (AC: 1)
  - [ ] Add pipecat-ai to requirements.txt
  - [ ] Install Daily transport module
  - [ ] Install Deepgram integration
  - [ ] Install Cartesia integration
  - [ ] Install Google Gemini integration
  - [ ] Document compatibility versions
  
- [ ] Create PipeCat bot script (AC: 1, 2, 8)
  - [ ] Create pipecat_bot/voice_bot.py
  - [ ] Import PipeCat framework components
  - [ ] Initialize DailyTransport with room URL and token
  - [ ] Implement async main() function
  - [ ] Load environment variables
  - [ ] Connect to Daily.co room
  - [ ] Start conversation pipeline
  
- [ ] Configure STT service (AC: 3)
  - [ ] Initialize DeepgramSTT service
  - [ ] Configure Nova-2 model
  - [ ] Set language to en-US
  - [ ] Configure interim results for responsiveness
  - [ ] Add error handling for STT failures
  
- [ ] Configure TTS service (AC: 4)
  - [ ] Initialize CartesiaTTS service
  - [ ] Configure Sonic-English voice
  - [ ] Set speaking rate and pitch
  - [ ] Configure audio format (16kHz, mono)
  - [ ] Add error handling for TTS failures
  
- [ ] Configure LLM service (AC: 5)
  - [ ] Initialize GeminiLLM service as primary
  - [ ] Configure Gemini 2.0 Flash model
  - [ ] Set temperature to 0.7 for balanced responses
  - [ ] Add OpenAI GPT-4 as fallback
  - [ ] Implement fallback logic on Gemini errors
  
- [ ] Implement system prompt loading (AC: 6, 7)
  - [ ] Load SYSTEM_PROMPT from environment
  - [ ] Validate prompt is not empty
  - [ ] Pass prompt to LLM configuration
  - [ ] Log category name for debugging
  
- [ ] Add database migration for system_prompt field (AC: 6)
  - [ ] Create Alembic migration script
  - [ ] Add system_prompt TEXT column to counselor_categories
  - [ ] Make column nullable (default NULL)
  - [ ] Update CounselorCategory model
  
- [ ] Create category-specific system prompts (AC: 6)
  - [ ] Write Health Counselor prompt
  - [ ] Write Career Counselor prompt
  - [ ] Write Academic Counselor prompt
  - [ ] Write Financial Aid Counselor prompt
  - [ ] Write Social Wellness Counselor prompt
  - [ ] Write Personal Development Coach prompt
  - [ ] Add prompts to seed data script
  
- [ ] Implement conversation loop (AC: 8)
  - [ ] Set up pipeline: STT → LLM → TTS
