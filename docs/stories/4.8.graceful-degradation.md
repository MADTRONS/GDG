...
- [ ] Implement continuous quality monitoring (AC: 1)
  - [ ] Monitor bitrate every 5 seconds
  - [ ] Monitor frame rate every 5 seconds
  - [ ] Monitor packet loss percentage
  - [ ] Monitor connection quality
  - [ ] Track quality over time (rolling 15-second window)
  
- [ ] Implement degradation detection logic (AC: 2)
  - [ ] Check if bitrate <500 kbps for 15+ seconds
  - [ ] Check if frame rate <15 fps for 15+ seconds
  - [ ] Check if packet loss >10% for 15+ seconds
  - [ ] Check if connection quality "poor" for 15+ seconds
  - [ ] Trigger degradation alert if any condition met
  
- [ ] Create degradation notification UI (AC: 3, 4)
  - [ ] Alert dialog with title and description
  - [ ] "Switch to Voice-Only" button (primary)
  - [ ] "Keep Trying Video" button (secondary)
  - [ ] Display current quality metrics
  - [ ] Show reason for degradation alert
  
- [ ] Implement voice-only mode switch (AC: 5)
  - [ ] Disable video track
  - [ ] Hide avatar video element
  - [ ] Keep audio tracks active
  - [ ] Update UI to show voice-only mode
  - [ ] Ensure no interruption to audio
  
- [ ] Implement "Keep Trying Video" logic (AC: 6)
  - [ ] Close notification
  - [ ] Set 30-second cooldown timer
  - [ ] Continue monitoring quality
  - [ ] Show notification again after cooldown if still poor
  
- [ ] Create voice-only mode UI (AC: 7)
  - [ ] Hide video section
  - [ ] Show audio waveform visualization
  - [ ] Display "Voice-Only Mode" indicator
  - [ ] Maintain transcript panel
  - [ ] Keep all controls (mute, volume, end session)
  
- [ ] Implement "Retry Video" functionality (AC: 8)
  - [ ] Show "Retry Video" button in voice-only mode
  - [ ] Re-enable video track on click
  - [ ] Show avatar video if successful
  - [ ] Fall back to voice-only if retry fails
  - [ ] Limit retries to 3 attempts
  
- [ ] Log degradation events (AC: 9)
  - [ ] Record degradation timestamp
  - [ ] Record trigger reason (bitrate, fps, packet loss, quality)
  - [ ] Record user choice (voice-only or keep trying)
  - [ ] Record retry attempts
  - [ ] Include in session quality metrics
  
- [ ] Write comprehensive tests
  - [ ] Test quality monitoring
  - [ ] Test degradation detection
  - [ ] Test notification display
  - [ ] Test voice-only mode switch
  - [ ] Test retry video functionality
  - [ ] Test degradation logging
  - [ ] Test cooldown timer
