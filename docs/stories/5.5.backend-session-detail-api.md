...
- [ ] Create session detail endpoint (AC: 1)
  - [ ] Add GET /api/sessions/{session_id} route
  - [ ] Apply authentication dependency
  - [ ] Parse sessionId from path parameter
  
- [ ] Implement query with authorization (AC: 2)
  - [ ] Query sessions table by session_id
  - [ ] Filter by authenticated user_id
  - [ ] Join with counselor_categories table
  - [ ] Exclude soft-deleted sessions
  
- [ ] Format response data (AC: 3, 5)
  - [ ] Include all required fields
  - [ ] Return full transcript array
  - [ ] Format timestamps as ISO strings
  - [ ] Include counselor category name and icon
  - [ ] Include quality metrics if available
  
- [ ] Add error handling (AC: 4)
...
- [ ] Write comprehensive tests (AC: 6)
  ...
  - [ ] Test transcript deserialization
  - [ ] Test soft-deleted session exclusion
...
5. **Manual Testing Checklist:**
   ...
   - [ ] Full transcript included in response
   - [ ] Transcript messages properly formatted
   - [ ] Timestamps in ISO format
   - [ ] Quality metrics included if available
   - [ ] Counselor category name and icon included
   - [ ] Soft-deleted sessions return 404
