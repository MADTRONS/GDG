...
- [ ] Create metrics endpoints (AC: 1, 2)
  - [ ] Add GET /api/admin/metrics/current
  - [ ] Add GET /api/admin/metrics/sessions
  - [ ] Calculate active sessions from last 5 minutes
  - [ ] Calculate average connection quality
  - [ ] Calculate error rate from logs
  - [ ] Measure API response time (p95)
  - [ ] Aggregate sessions by category
  
- [ ] Build admin dashboard page (AC: 3)
  - [ ] Create /admin/dashboard route
  - [ ] Display metrics in card grid
  - [ ] Implement 30-second auto-refresh
  - [ ] Loading states for metrics
  
- [ ] Create connection quality gauge (AC: 4)
  - [ ] Query quality metrics from sessions
  - [ ] Calculate distribution percentages
  - [ ] Visualize with pie chart or gauge
  
- [ ] Implement real-time updates (AC: 5)
  - [ ] Use polling (simpler) or WebSocket
  - [ ] Update active sessions counter
  - [ ] Throttle updates to avoid overload
  
- [ ] Add system health indicators (AC: 6)
  - [ ] Define health thresholds
  - [ ] Green: all metrics normal
  - [ ] Yellow: degraded (high response time)
  - [ ] Red: critical (errors > threshold)
  
- [ ] Create error rate chart (AC: 7)
  - [ ] Query error logs from last 24 hours
  - [ ] Display line chart with hourly buckets
  - [ ] Highlight threshold crossings
  
- [ ] Display database connection pool status (AC: 8)
  - [ ] Query SQLAlchemy pool stats
  - [ ] Show active/idle connections
  - [ ] Show pool size and overflow
  
- [ ] Add external service indicators (AC: 9)
  - [ ] Check Daily.co API health
  - [ ] Check LiveKit API health
  - [ ] Check Beyond Presence API health
  - [ ] Display status badges
  
- [ ] Implement role-based access (AC: 10)
  - [ ] Restrict to SYSTEM_MONITOR and SUPER_ADMIN
